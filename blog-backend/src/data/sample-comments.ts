...
export default function readSampleComments(): IComment[] {
  return [
    ...
    { postId: "7", id: "5", comment: "ndolor quam autem quasi" },
    {
      postId: "7",
      id: "6",
      comment: "reiciendis et nam sapiente accusantium",
    },
    {
      postId: "7",
      id: "7",
    ...
    },
    {
      ...
      id: "15",
      comment:
        "Very good explanation, eventhough there are some minor mistakes you should avoid in the future",
    },
  ];
}
